      ...
      <IonContent>
        <div className="question1">
          <IonCard>
            ...
            <IonCardContent>
              Last year was about new challenges and the beginning of a long but worth while journey.
            </IonCardContent>
          </IonCard>
        </div>
        <div className="question1">
        ...
        <div className="questions">
          <IonCard>
            ...
            <IonCardContent>I would call it the year of growth.</IonCardContent>
          </IonCard>
        </div>
      </IonContent>
    </IonPage>
